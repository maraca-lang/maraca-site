[
  ...
  [
    ...
    [style: 18 bold, Index],
    "To turn a keyed list into an indexed one, map through it and unpack each item onto the next available index.",
    code?.["#data.[v=>> :: [v?]]"],,
    ...
    [style: 18 bold, Slice],
    "First index, then filter as above but using the keys rather than the values, then index again.",
    code?
      .[
        "#data
        .[v=>> :: [v?]]
