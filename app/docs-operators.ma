[
  ...
  [
    ...
    [style: 18 bold, Minus],
    "As well as the above 'a - b' form, minus can also operate on a single value, which doesn't have to be numeric (the negative of a text value is useful for sorting).",
    code?.["-20", "-Hello"],,
