...
.[
  ...
  [
    ...
    [
      ...
      and numbers can be written directly. Other characters must either be
      prefixed with a <: @Util.Format.[\\, function]/>, or part of a value
      surrounded with single quotes.",
    ],
    @Example.[Hello, '\\£', '\'132-3004-132\'', width: 60, nooutput: true],
    [
