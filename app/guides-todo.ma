[
  ...
  [
    ...
    code3?
      ."{ todos: [Item 1, Item 2, Item 3], [ gap: 10, pad: 20, [style: bold,
      Todos App], ~: todos?, ], }",,
    ...
    light.",
    code3?
      ."{ todos: [Item 1, Item 2, Item 3], new: , [ gap: 10, pad: 20, [style:
      bold, Todos App], [ input: new?, fill: 80 80 95, pad: 10, ], ~: todos?, ],
      }",,
    ...
    code3?
      ."{ todos: [Item 1, Item 2, Item 3], new: , [ gap: 10, pad: 20, [style:
      bold, Todos App], [ input: new?, fill: 80 80 95, pad: 10, enter? | [new?,
      ~: todos?] -\> todos?, enter? | \"\" -\> new?, ], ~: todos?.[t=\>\>
      [style: bullet, t?]], ], }",,
    ...
    code3?
      ."{ todos: [ [text: Item 1, done: ], [text: Item 2, done: ], [text: Item
      3, done: ], ], new: , next: [[text: new?, done: ], ~: todos?],,

      renderTodo: [ t=\> [ style: bullet (t?.done, strike italic), t?.text,
      click? | !t?.done -\> t?.done, ], ],,

      [ gap: 10, pad: 20, [style: bold, Todos App], [ input: new?, fill: 80 80
      95, pad: 10, enter? | next? -\> todos?, enter? | \"\" -\> new?, ], ~:
