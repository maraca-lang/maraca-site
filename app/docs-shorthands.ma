[
  gap: 40,
  [style: 40 bold, color: colors?.red, Shorthands],
  [
    gap: 25,,

    "The fact that nil values are removed from lists can be used to form AND/OR boolean logic expressions. These constructs each have a shorthand form using a different bracket type.",
    "These shorthands can then also be used in other ways, such as for grouping expressions, writing imperative code, and forming ternary operations.",,
