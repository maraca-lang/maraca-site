[
  ...
  [
    ...
    "Where relevant, component properties are reactive, updating automatically in response to events and user input. These reactive streams are what you use to build interactivity into your UI.",
  ],
  [
    gap: 25,,

    [style: 26 bold, color: colors?.red, "Hover & focus"],
    "Set the 'hover' and 'focus' properties to nil to watch for changes to a box's state. The value can then be used elsewhere, for example to change the background color.",
    code2?
      .[
        "[
          pad: 10,
  ...
  [
    ...
    "Similarly, set the 'height' and 'width' properties to nil to watch for changes to a box's size.",
    code2?
      .[
        "[
          pad: 10,
